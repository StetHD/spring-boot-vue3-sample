package com.energizeglobal.egsinterviewtest.util.liquibase;
...
import static com.energizeglobal.egsinterviewtest.config.Constants.*;
...
public class AsyncSpringLiquibase extends DataSourceClosingSpringLiquibase {
    ...
    public void afterPropertiesSet() throws LiquibaseException {
        if (!this.environment.acceptsProfiles(Profiles.of(SPRING_PROFILE_NO_LIQUIBASE))) {
            if (this.environment.acceptsProfiles(Profiles.of(SPRING_PROFILE_DEVELOPMENT))) {
                try {
