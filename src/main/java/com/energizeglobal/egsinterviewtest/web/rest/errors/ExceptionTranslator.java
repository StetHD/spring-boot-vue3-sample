...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
            com.energizeglobal.egsinterviewtest.service.EmailAlreadyUsedException ex,
        ...
        return create(
                problem,
                request,
                HeaderUtil.createFailureAlert(applicationName, true,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
            com.energizeglobal.egsinterviewtest.service.UsernameAlreadyUsedException ex,
            NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
            com.energizeglobal.egsinterviewtest.service.InvalidPasswordException ex,
            NativeWebRequest request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.",
                "java.", "net.", "javax.", "com.", "io.", "de.", "com.mycompany.myapp");
    }
}
